import { Box, Button, createListCollection, Field, FileUpload, Image, Input, Stack } from "@chakra-ui/react"
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
          <Stack gap="4" align="flex-start" >
            ...
            <Field.Root invalid={!!errors.image} width="full" gap={2}>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FileUpload.Root accept="image/*" flex={1}>
                      <FileUpload.HiddenInput role="profile_image" {...register('image')} type='file' name='image' onChange={(value) => {
              ...
              <Field.ErrorText role="error">{String(errors?.image?.message)}</Field.ErrorText>
            </Field.Root>
            {/* first name */}
            <Field.Root invalid={!!errors.firstName} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                <Input minLength={4} maxLength={30} placeholder={'Firstname'} type="text" width={'full'} {...register("firstName", { required: "First name is required" })} name="firstName" />
                <Field.ErrorText role="error">{String(errors?.firstName?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            ...
            <Field.Root invalid={!!errors.lastName} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                ...
                <Field.ErrorText role="error">{String(errors?.lastName?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            ...
            <Field.Root invalid={!!errors.birthday} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }}>
                ...
                />
                <Field.ErrorText role="error">{String(errors?.birthday?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            {/* gender */}
            <Field.Root invalid={!!errors.gender} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }}>
                ...
                />
                <Field.ErrorText role="error">{String(errors?.gender?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            {/* phones */}
            <Field.Root invalid={!!errors.phone} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }} >
                ...
                />
                <Field.ErrorText role="error">{String(errors?.phone?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            {/* email */}
            <Field.Root invalid={!!errors.email} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                ...
                <Field.ErrorText role="error">{String(errors?.email?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            {/* password */}
            <Field.Root invalid={!!errors.password} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                ...
                <Field.ErrorText role="error">{String(errors?.password?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            {/* confirm password */}
            <Field.Root invalid={!!errors.confirmPassword} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                ...
                <Field.ErrorText role="error">{String(errors?.confirmPassword?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            {/* passport series */}
            <Field.Root invalid={!!errors.passportseries} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Box width={{ base: 'full', md: '80%' }}>
                ...
                <Field.ErrorText role="error">{String(errors?.passportseries?.message)}</Field.ErrorText>
              </Box>
            </Field.Root>
            {/* skill sets */}
            <Field.Root invalid={!!errors.skills} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }}>
                ...
                />
                <Field.ErrorText role="error">{String(errors?.skills?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            {/* role */}
            <Field.Root invalid={!!errors.role} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }}>
                ...
                />
                <Field.ErrorText role="error">{String(errors?.role?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            <Field.Root invalid={!!errors.numberOfCars} width="full" display={'flex'} alignItems={'center'} flexDirection={{ base: 'column', md: 'row' }} gap={2}>
              ...
              <Stack width={{ base: 'full', md: '80%' }}>
                ...
                />
                <Field.ErrorText role="error">{String(errors?.numberOfCars?.message)}</Field.ErrorText>
              </Stack>
            </Field.Root>
            <Box display={'flex'} gap={2} width={'full'} justifyContent={'flex-end'}>
              <Button role="form_reset" onClick={() => reset()} color="blue.500" variant={'outline'} type="reset">Reset</Button>
              <Button role="form_submit" colorPalette="blue" variant={'solid'} onClick={handleSubmit(onSubmit)} type="submit">Submit</Button>
            </Box>
          </Stack>
        </form>
      </Box>
